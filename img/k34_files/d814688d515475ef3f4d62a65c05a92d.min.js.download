...
jQuery( document ).ready( function() {
    ...
    jQuery( '.fss-wrapper .fss-filters' ).find( 'li:first-child' ).find( 'input' ).prop( 'checked', true ).trigger( 'change' );
} );
